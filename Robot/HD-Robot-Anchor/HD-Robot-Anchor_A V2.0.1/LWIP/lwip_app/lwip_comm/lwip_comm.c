...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	lwipx->remoteip[0]= Network_Manage_t.remoteip[0];	
	lwipx->remoteip[1]= Network_Manage_t.remoteip[1];
	lwipx->remoteip[2]= Network_Manage_t.remoteip[2];
	lwipx->remoteip[3]= Network_Manage_t.remoteip[3];
	...
	lwipx->ip[0]= Network_Manage_t.ip[0];	
	lwipx->ip[1]= Network_Manage_t.ip[1];
	lwipx->ip[2]= Network_Manage_t.ip[2];
	lwipx->ip[3]= Network_Manage_t.ip[3];
	...
	lwipx->netmask[3]=0;
	//默认网关:192.168.1.1
	lwipx->gateway[0]= Network_Manage_t.ip[0];	
	lwipx->gateway[1]= Network_Manage_t.ip[1];
	lwipx->gateway[2]=1;
	lwipx->gateway[3]=1;	
...
u8 lwip_comm_init(void)
{
  ...
  printf("LocalPort = %d, RemotePort = %d", Network_Manage_t.local_port, Network_Manage_t.remote_port);
#endif
