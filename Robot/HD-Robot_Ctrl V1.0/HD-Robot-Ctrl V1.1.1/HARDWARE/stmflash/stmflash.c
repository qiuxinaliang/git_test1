...
void STMFLASH_HeaderDistanceOffset_Write(void)   	
{
	...
	memset((uint32_t *)&STMFlashReadWrite_Stru_temp, 0, sizeof(STMFlashReadWrite_Stru));
	STMFLASH_Read(ADDR_FLASH_SECTOR_7,(uint32_t *)&STMFlashReadWrite_Stru_temp,sizeof(STMFlashReadWrite_Stru)/4); 
	memcpy((uint8_t *)&STMFlashReadWrite_Stru_temp.DistanceOffset_Stru_temp.FollowModeOffset_Stru_temp[0],(uint8_t *)&DistanceOffset_Stru_temp.FollowModeOffset_Stru_temp[0],                                                                       sizeof(FollowModeOffset_Stru));
	STMFLASH_Write(ADDR_FLASH_SECTOR_7 ,(uint32_t *)&STMFlashReadWrite_Stru_temp,sizeof(STMFlashReadWrite_Stru)/4);//写入一个字 
}
...
void STMFLASH_LeftDistanceOffset_Write(void)   	
{
	...
	memset((uint32_t *)&STMFlashReadWrite_Stru_temp, 0, sizeof(STMFlashReadWrite_Stru));
	STMFLASH_Read(ADDR_FLASH_SECTOR_7,(uint32_t *)&STMFlashReadWrite_Stru_temp,sizeof(STMFlashReadWrite_Stru)/4); 
	memcpy((uint8_t *)&STMFlashReadWrite_Stru_temp.DistanceOffset_Stru_temp.FollowModeOffset_Stru_temp[1],(uint8_t *)&DistanceOffset_Stru_temp.FollowModeOffset_Stru_temp[1],                                                                         sizeof(FollowModeOffset_Stru));
	STMFLASH_Write(ADDR_FLASH_SECTOR_7 ,(uint32_t *)&STMFlashReadWrite_Stru_temp,sizeof(STMFlashReadWrite_Stru)/4);//写入一个字 
}
/* 右跟随距离补偿参数保存 */
